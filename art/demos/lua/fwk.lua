--autogenerated luajit bindings. do not edit. 2022/07/16
...
//lcpp INF [0000] vec2: macro name but used as C declaration in:typedef union vec2 { struct { float X,Y; };     struct { float x,y; }; struct { float r,g; }; struct { float w,h; }; struct { float min,max; }; struct { float from,to; }; struct { float src,dst; }; float v2[2]; float array[1]; } vec2;
//lcpp INF [0000] vec3: macro name but used as C declaration in:typedef union vec3 { struct { float X,Y,Z; };   struct { float x,y,z; }; struct { float r,g,b; }; struct { float w,h,d; }; vec2 xy; vec2 rg; vec2 wh; float v3[3]; float array[1]; } vec3;
//lcpp INF [0000] vec2: macro name but used as C declaration in:typedef union vec3 { struct { float X,Y,Z; };   struct { float x,y,z; }; struct { float r,g,b; }; struct { float w,h,d; }; vec2 xy; vec2 rg; vec2 wh; float v3[3]; float array[1]; } vec3;
//lcpp INF [0000] vec2: macro name but used as C declaration in:typedef union vec3 { struct { float X,Y,Z; };   struct { float x,y,z; }; struct { float r,g,b; }; struct { float w,h,d; }; vec2 xy; vec2 rg; vec2 wh; float v3[3]; float array[1]; } vec3;
//lcpp INF [0000] vec2: macro name but used as C declaration in:typedef union vec3 { struct { float X,Y,Z; };   struct { float x,y,z; }; struct { float r,g,b; }; struct { float w,h,d; }; vec2 xy; vec2 rg; vec2 wh; float v3[3]; float array[1]; } vec3;
//lcpp INF [0000] array: macro name but used as C declaration in:typedef union vec3 { struct { float X,Y,Z; };   struct { float x,y,z; }; struct { float r,g,b; }; struct { float w,h,d; }; vec2 xy; vec2 rg; vec2 wh; float v3[3]; float array[1]; } vec3;
//lcpp INF [0000] vec3: macro name but used as C declaration in:typedef union vec3 { struct { float X,Y,Z; };   struct { float x,y,z; }; struct { float r,g,b; }; struct { float w,h,d; }; vec2 xy; vec2 rg; vec2 wh; float v3[3]; float array[1]; } vec3;
//lcpp INF [0000] vec4: macro name but used as C declaration in:typedef union vec4 { struct { float X,Y,Z,W; }; struct { float x,y,z,w; }; struct { float r,g,b,a; }; vec2 xy; vec3 xyz; vec2 rg; vec3 rgb; vec2 wh; vec3 whd; float v4[4]; float array[1]; } vec4;
//lcpp INF [0000] vec2: macro name but used as C declaration in:typedef union vec4 { struct { float X,Y,Z,W; }; struct { float x,y,z,w; }; struct { float r,g,b,a; }; vec2 xy; vec3 xyz; vec2 rg; vec3 rgb; vec2 wh; vec3 whd; float v4[4]; float array[1]; } vec4;
//lcpp INF [0000] vec3: macro name but used as C declaration in:typedef union vec4 { struct { float X,Y,Z,W; }; struct { float x,y,z,w; }; struct { float r,g,b,a; }; vec2 xy; vec3 xyz; vec2 rg; vec3 rgb; vec2 wh; vec3 whd; float v4[4]; float array[1]; } vec4;
//lcpp INF [0000] vec2: macro name but used as C declaration in:typedef union vec4 { struct { float X,Y,Z,W; }; struct { float x,y,z,w; }; struct { float r,g,b,a; }; vec2 xy; vec3 xyz; vec2 rg; vec3 rgb; vec2 wh; vec3 whd; float v4[4]; float array[1]; } vec4;
//lcpp INF [0000] vec3: macro name but used as C declaration in:typedef union vec4 { struct { float X,Y,Z,W; }; struct { float x,y,z,w; }; struct { float r,g,b,a; }; vec2 xy; vec3 xyz; vec2 rg; vec3 rgb; vec2 wh; vec3 whd; float v4[4]; float array[1]; } vec4;
//lcpp INF [0000] vec2: macro name but used as C declaration in:typedef union vec4 { struct { float X,Y,Z,W; }; struct { float x,y,z,w; }; struct { float r,g,b,a; }; vec2 xy; vec3 xyz; vec2 rg; vec3 rgb; vec2 wh; vec3 whd; float v4[4]; float array[1]; } vec4;
//lcpp INF [0000] vec3: macro name but used as C declaration in:typedef union vec4 { struct { float X,Y,Z,W; }; struct { float x,y,z,w; }; struct { float r,g,b,a; }; vec2 xy; vec3 xyz; vec2 rg; vec3 rgb; vec2 wh; vec3 whd; float v4[4]; float array[1]; } vec4;
//lcpp INF [0000] array: macro name but used as C declaration in:typedef union vec4 { struct { float X,Y,Z,W; }; struct { float x,y,z,w; }; struct { float r,g,b,a; }; vec2 xy; vec3 xyz; vec2 rg; vec3 rgb; vec2 wh; vec3 whd; float v4[4]; float array[1]; } vec4;
//lcpp INF [0000] vec4: macro name but used as C declaration in:typedef union vec4 { struct { float X,Y,Z,W; }; struct { float x,y,z,w; }; struct { float r,g,b,a; }; vec2 xy; vec3 xyz; vec2 rg; vec3 rgb; vec2 wh; vec3 whd; float v4[4]; float array[1]; } vec4;
...
//lcpp INF [0000] vec2: macro name but used as C declaration in:API vec2  div2     (vec2   a, float  b);
//lcpp INF [0000] vec2: macro name but used as C declaration in:STATIC vec2  div2     (vec2   a, float  b);
//lcpp INF [0000] vec2: macro name but used as C declaration in:STATIC vec2  div2     (vec2   a, float  b);
...
//lcpp INF [0000] vec3: macro name but used as C declaration in:API vec3  div3     (vec3   a, float  b);
//lcpp INF [0000] vec3: macro name but used as C declaration in:STATIC vec3  div3     (vec3   a, float  b);
//lcpp INF [0000] vec3: macro name but used as C declaration in:STATIC vec3  div3     (vec3   a, float  b);
...
//lcpp INF [0000] vec4: macro name but used as C declaration in:API vec4  div4     (vec4   a, float  b);
//lcpp INF [0000] vec4: macro name but used as C declaration in:STATIC vec4  div4     (vec4   a, float  b);
//lcpp INF [0000] vec4: macro name but used as C declaration in:STATIC vec4  div4     (vec4   a, float  b);
...
//lcpp INF [0000] vec4: macro name but used as C declaration in:API vec4 transform444(const mat44, const vec4);
//lcpp INF [0000] vec4: macro name but used as C declaration in:STATIC vec4 transform444(const mat44, const vec4);
//lcpp INF [0000] vec4: macro name but used as C declaration in:STATIC vec4 transform444(const mat44, const vec4);
...
//lcpp INF [0000] vec3: macro name but used as C declaration in:API void ddraw_box(vec3 c, vec3 extents);
//lcpp INF [0000] vec3: macro name but used as C declaration in:STATIC void ddraw_box(vec3 c, vec3 extents);
//lcpp INF [0000] vec3: macro name but used as C declaration in:STATIC void ddraw_box(vec3 c, vec3 extents);
...
COOKER_CANCELABLE = 2,
 ...
 void cooker_config( const char *art_path, const char *tools_path, const char *fwk_ini );
